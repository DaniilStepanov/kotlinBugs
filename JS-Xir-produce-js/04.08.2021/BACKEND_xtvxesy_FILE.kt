...
// FILE: tmp0.kt
 ...
 fun doCall( block1: Int,finallyBlock1: Any ):Int = TODO()
class Holder
fun test1(h: Any )   = 
    doCall (
            TODO(),{
...
// File being compiled: (85,2) in /home/stepanov/Kotlin/bbfgradle/tmp/tmp0.kt
// The root cause java.lang.AssertionError was thrown at: org.jetbrains.kotlin.psi2ir.intermediate.VariableLValue.store(VariableLValue.kt:51)
// Not a variable: value-parameter h: Holder defined in test2[ValueParameterDescriptorImpl@5fdb6d66]: KtBinaryExpression:
// h = Holder()
...
// Caused by: java.lang.AssertionError: Not a variable: value-parameter h: Holder defined in test2[ValueParameterDescriptorImpl@5fdb6d66]
// 	at org.jetbrains.kotlin.psi2ir.intermediate.VariableLValue.store(VariableLValue.kt:51)
// 	at org.jetbrains.kotlin.psi2ir.intermediate.AssignmentReceiver$assign$1.invoke(Values.kt:35)
// 	at org.jetbrains.kotlin.psi2ir.intermediate.AssignmentReceiver$assign$1.invoke(Values.kt:35)
// 	at org.jetbrains.kotlin.psi2ir.intermediate.VariableLValue.assign(VariableLValue.kt:56)
// 	at org.jetbrains.kotlin.psi2ir.intermediate.AssignmentReceiver$DefaultImpls.assign(Values.kt:35)
// 	at org.jetbrains.kotlin.psi2ir.intermediate.VariableLValue.assign(VariableLValue.kt:30)
// 	at org.jetbrains.kotlin.psi2ir.generators.AssignmentGenerator.generateAssignment(AssignmentGenerator.kt:53)
// 	at org.jetbrains.kotlin.psi2ir.generators.OperatorExpressionGenerator.generateBinaryExpression(OperatorExpressionGenerator.kt:136)
...
// 	at org.jetbrains.kotlin.psi2ir.generators.OperatorExpressionGenerator.generateEqualityOperator(OperatorExpressionGenerator.kt:330)
...
// 	at org.jetbrains.kotlin.psi.KtIfExpression.accept(KtIfExpression.java:33)
// 	at org.jetbrains.kotlin.psi2ir.generators.StatementGenerator.generateStatement(StatementGenerator.kt:69)
// 	at org.jetbrains.kotlin.psi2ir.generators.BodyGenerator.generateLambdaBody(BodyGenerator.kt:97)
