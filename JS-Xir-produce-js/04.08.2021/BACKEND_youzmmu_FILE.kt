...
// File being compiled: (65,5) in /home/stepanov/Kotlin/bbfgradle/tmp/tmp0.kt
...
// No type for expression: { while (true == true) {
// 
//  
//     if (Value<Array<Int>>(Array<Int>(0) { 20 }).test() == 1) {
...
// Caused by: java.lang.RuntimeException: No type for expression: { while (true == true) {
// 
//  
//     if (Value<Array<Int>>(Array<Int>(0) { 20 }).test() == 1) {
//         throw AssertionError()
