...
fun fu0(x: Unit? = hashMapOf<Kla0?, String>(Pair<Kla0?, String>(Kla0, "xjzwo")).minusAssign<Kla0?, String>("khzee".map<Kla0?>({a: Char -> Kla0}))) = null == null
...
fun fu2(a: Float? = 66.407166f, b: Float? = -73.38814f) = (92).equals("dfexp").not()

fun fu3(a: Float?, b: Float? = 74.351776f) = a != null && (fu0(println("scpjp"))).equals("gyjix").xor(false) && (ArrayDeque<Int>(16)).isNotEmpty()
