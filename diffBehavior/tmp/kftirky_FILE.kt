...
import kotlin.math.*
val range0 = '1' until '3'.titlecase().lastOrNull()!!
...
throw AssertionError()
    ...
    if (!(element3 !in range0).or(true) != range0.contains('0')) {
println("""THEN""");
throw AssertionError()
}
...
fun testR1xE0() {
    // with possible local optimizations
    if ('0' in '3' until '1' != range1.contains('0').and(false)) {
println("""THEN""");
throw AssertionError()
}
...
throw AssertionError()
    ...
    if (!(element4 in '3' until '1').xor(false) != !range1.contains('1')) {
println("""THEN""");
throw AssertionError()
}
    if (!('1' !in '3' until '1') != range1.contains('1')) {
...
throw AssertionError()
    ...
    if (!(element4 !in '3' until '1') != range1.endInclusive.until(element0).contains(element4)) {
println("""THEN""");
throw AssertionError()
}
}
